...
export const useRecordCanvas = (canvas) => {
    ...
    const onRecordingBlob = useCallback(({ data }) => mediaBlobsRef.current.push(data), [ mediaBlobsRef ]);
    ...
    const startRecording = useCallback(() => recorder && recorder.start(100), [ recorder ]);
