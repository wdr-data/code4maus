...
export const features = {
    ...
    [FEATURE_OFFLINE]: {
        description: 'Offline Support: Programmieren mit der Maus ohne Internet benutzen (nur Chrome)',
    },
    [FEATURE_SHARING]: {
        description: 'Teilen Toolbox: Screenshot oder GIF der Bühne aufnehmen und per QR-Code herunterladen',
    },
    [FEATURE_PRINTING]: {
        description: 'Screenshots drucken: ermöglicht Screenshots mit Button Layout zu drucken (nur mit Teilen Toolbox und Print Server nutzbar)',
    },
};
...
export const useFeatureState = () => {
    ...
    return useMemo(() => Object.entries(features).map(([ id, def ]) => {
        return {
            id,
