  ...
  <div className={styles.pageWrapper}>
    ...
    <div className={styles.blockWrapper}>
      ...
      <div className={classNames(styles.innerWrapper, styles.thirdWrapper)}>
        <p>
          Auf der re:publica kann Programmieren mit der Maus von Groß UND Klein{' '}
          <span className={styles.boldOrange}>#mausprobiert </span>
          werden. Spielerisch mit Code Bilder mit der Maus, der Ente und dem
          Elefanten erzeugen, das Ergebnis dann teilen oder einfach direkt als
          Button ausdrucken.
        </p>
      </div>
    </div>
